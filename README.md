...
- **Product Types & Variants**: Support for complex product structures (Wearables, Food, Devices, Travel) with individual SKU-level price and inventory tracking.
- **Multi-Attribute Variant Selection**: Guided bot flows for complex products (e.g., Color -> Size) with recursive auto-completion and real-time stock validation.
